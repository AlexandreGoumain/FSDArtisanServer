...
import { createFurnitureCategory, deleteFurnitureCategory, getAllFurnitureCategories, getFurnitureCategoryById, updateFurnitureCategory } from "../controllers/furnitureCategories.controller"

...
export const getAllRessources = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(res, 200, 'Liste des ressources récupérée avec succès.', ressources);
    } catch (error) {
        standardResponse(res, 500, 'Erreur serveur lors de la récupération des ressources.', error);
    }
}
...
export const getRessourceById = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(res, 200, 'Ressource récupérée avec succès.', ressource);
    } catch (error) {
        standardResponse(res, 500, 'Erreur serveur lors de la récupération de la ressource.', error);
    }
}
...
export const createRessource = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(res, 500, 'Erreur serveur lors de la création de la ressource.', error);
    }
}
...
export const updateRessource = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(res, 200, 'Ressource mise à jour avec succès.', ressource);
    } catch (error) {
        if (error instanceof z.ZodError) {
            standardResponse(res, 400, 'Validation échouée.', error.errors);
            return;
        }
        standardResponse(res, 500, 'Erreur serveur lors de la mise à jour de la ressource.', error);
    }
}
...
export const deleteRessource = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(res, 500, 'Erreur serveur lors de la suppression de la ressource.', error);
    }
}

...
export const getAllFurnitures = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(
            res,
            200,
            "Liste des meubles récupérée avec succès.",
            furnitures
        );
    } catch (error) {
        standardResponse(
            res,
            500,
            "Erreur serveur lors de la récupération des meubles.",
            error
        );
    }
};
...
export const getFurnitureById = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(
            res,
            500,
            "Erreur serveur lors de la récupération du meuble.",
            error
        );
    }
};
...
export const createFurniture = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(
            res,
            500,
            "Erreur serveur lors de la création du meuble.",
            error
        );
    }
};
...
export const updateFurniture = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(
            res,
            500,
            "Erreur serveur lors de la mise à jour du meuble.",
            error
        );
    }
};
...
export const deleteFurniture = async (req: Request, res: Response) => {
    try {
        ...
        standardResponse(
            res,
            500,
            "Erreur serveur lors de la suppression du meuble.",
            error
        );
    }
};
